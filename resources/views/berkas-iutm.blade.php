	...
	<div class="contentSize">
		<table style="width:60%;">
			...
			<tr>
				...
				<td style="width:40%;"><a href="/images/uploaded-image/{{$permohonan->domisili}}">{{$permohonan->domisili}}</a></td>
			</tr>
			<tr>
				<td style="width:1%;"><input type="checkbox" name="amdalValid" value="valid"></td>
				<td style="width:15%;">Amdal</td>
				<td style="width:40%;"><a href="/images/uploaded-image/{{$permohonan->amdal}}">{{$permohonan->amdal}}</a></td>
			</tr>
			<tr>
				<td style="width:1%;"><input type="checkbox" name="mitraValid" value="valid"></td>
				<td style="width:15%;">Rencana Mitra</td>
				<td style="width:40%;"><a href="/images/uploaded-image/{{$permohonan->rencanaMitra}}">{{$permohonan->rencanaMitra}}</a></td>
			</tr>
		</table><br>
