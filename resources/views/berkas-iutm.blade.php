...
<h2> Berkas IUTM, IUPP, IUPPT</h2><br><br>
	...
	<form id="setuju" method="post" action="/iusp/public/admin/setujuIUTM">
		<input name="_token" hidden value="{!! csrf_token() !!}" />
		<input type="hidden" name="id" value="{{$permohonan->id}}">	
	</form>
	<form id="tolak" method="post" action="/iusp/public/admin/tolakIUTM">
		<input name="_token" hidden value="{!! csrf_token() !!}" />
		<input type="hidden" name="id" value="{{$permohonan->id}}">	
	</form>
	...
	<div class="contentSize">
		<table style="width:60%;">
			...
			<tr>
				...
				<td style="width:40%;">HO/2015/4/1</td>
			</tr>
			<tr>
				<td style="width:1%;"><input type="checkbox" name="KepemilikanTempatValid" value="valid"></td>
