...
Route::post('perpanjangIUTM','PermohonanController@perpanjangIUTM');
Route::post('perpanjangSTPW','PermohonanController@perpanjangSTPW');
Route::post('perpanjangITPMB','PermohonanController@perpanjangITPMB');
